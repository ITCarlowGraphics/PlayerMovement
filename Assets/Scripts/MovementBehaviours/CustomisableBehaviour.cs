...
public class CustomisableBehaviour
{
    ...
    {
        const float bounceIntensity = 2.0f; // Higher values make it "bouncier"
    ...
    {
        const float zigzagWidth = 0.5f; // Distance of each zig or zag
        int numZigZags = 5; // Number of zigzag cycles
